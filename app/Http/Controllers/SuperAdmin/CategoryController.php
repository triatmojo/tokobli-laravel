...
class CategoryController extends Controller
{
                        ...
                        <div class="btn-group">
                            <div class="dropdown">
                               ...
                               <div class="dropdown-menu">
                                 <a class="dropdown-item" href="' . route('category.edit', $item->id) . '">Update</a>
    ...
    {
        return view('pages.super-admin.category.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.super-admin.category.update', [
            'item' => $item
        ]);
    }
